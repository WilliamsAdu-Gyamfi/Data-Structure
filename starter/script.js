...
console.log("Williams Adu-Gyamfi".split(" "));
...
document.querySelector("button").addEventListener("click", function () {
  ...
  const horizontal = text.split("\n");
  console.log(horizontal);
  console.log(text);

  //lopping over and array and loging the variables converted to camelCase
  for (const [i, zone] of horizontal.entries()) {
    const [first, second] = zone.toLowerCase().trim().split("_");
